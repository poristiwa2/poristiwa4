import { categories, timeAgo } from '../data/mockData';
import type { Article } from '../data/mockData';

type Nav = (page: string, params?: Record<string, string>) => void;

export default function Card({ a, variant, nav }: { a: Article; variant?: string; nav: Nav }) {
      ...
      <div className="group cursor-pointer relative rounded-xl overflow-hidden" onClick={go}>
        <div className={a.gradient + " aspect-video md:aspect-[21/9]"}>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8">
            ...
            <h2 className="text-xl md:text-3xl font-extrabold text-white leading-tight mb-2 group-hover:text-red-300 transition line-clamp-3">{a.title}</h2>
